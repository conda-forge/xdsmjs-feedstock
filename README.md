...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xdsmjs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11617&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xdsmjs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xdsmjs` can be installed with:

```
conda install xdsmjs
```

It is possible to list all of the versions of `xdsmjs` available on your platform with:
